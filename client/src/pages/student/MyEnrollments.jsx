...
const MyEnrollments = () => {
  ...
  // Dummy progress for each course (replace with real data if available)
  const progressArray = enrolledCourses.map(course => ({
    lectureCompleted: 0, // Set actual completed lectures if you track them
    totalLectures: course.courseContent
      ? course.courseContent.reduce((acc, chapter) => acc + (chapter.chapterContent?.length || 0), 0)
      : 0,
  }));
    ...
    <>
      <div className='md:px-36 px-8 pt-10'>
        ...
        <table className="md:table-auto table-fixed w-full overflow-hidden border mt-10">
          <thead className="text-gray-900 border-b border-gray-500/20 text-base text-left max-sm:hidden">
            <tr>
                ...
                <td className="md:px-4 pl-2 md:pl-4 py-3 flex items-center space-x-3 ">
                  ...
                  <div className='flex-1'>
                    ...
                    <Line
                      ...
                      strokeWidth={2}
                      percent={progressArray[index].totalLectures
